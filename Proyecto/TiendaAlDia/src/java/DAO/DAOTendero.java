...
public class DAOTendero{
    ...
    public int insertarTendero(TOTendero toTenderos) {
        String[] valores = {toTenderos.getUsuario(), toTenderos.getContrasena(), String.valueOf(toTenderos.getIdUsuariosTendero()), toTenderos.getNombreTienda()};
        try {
    ...
    public boolean actualizarTendero(TOTendero toTenderos) {
        ...
        try {
            return con.actualizar(nombreTabla, columnas, valores, toTenderos.getIdTendero(), "idTendero");
      ...
      public boolean eliminarTendero(int idTendero) {
        try {
            return con.eliminar(nombreTabla,idTendero,"idTendero");
